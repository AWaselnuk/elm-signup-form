...
Elm.SignupForm.make = function (_elm) {
   ...
   model) {
      return function () {
         ...
         var newErrors = _U.replace([["storenameTaken"
                                     ,isTaken]],
         currentErrors);
   ...
   var getErrors = function (model) {
      return {_: {}
             ...
             ,storename: _U.eq(model.storename,
   ...
   model) {
      ...
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("storename")]),
                   _L.fromArray([$Html.text("Your store name")]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.id("storename")
                                ,$Html$Attributes.type$("text")
                                ,$Html$Attributes.value(model.storename)
                                ,A3($Html$Events.on,
                                "input",
   ...
   model) {
      ...
      _L.fromArray([$Html$Attributes.$class("form-control")]),
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for("email")]),
                   _L.fromArray([$Html.text("Email address ")]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.id("email")
                                ,$Html$Attributes.type$("text")
   ...
   model) {
      return A2($Html.form,
      _L.fromArray([$Html$Attributes.id("form-signup")]),
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([$Html$Attributes.$class("text-center")]),
                   _L.fromArray([$Html.text("Start your free 999-day trial of Shopify")]))
                   ,A2(emailInputView,
                   actionDispatcher,
                   model)
                   ,A2(passwordInputView,
                   actionDispatcher,
                   model)
                   ,A2(storenameInputView,
                   actionDispatcher,
                   model)
                   ,A2($Html.div,
